...
use adex_protocol_substrate_runtime::{self, GenesisConfig, opaque::Block, ClientWithApi};
...
native_executor_instance!(
	pub Executor,
	adex_protocol_substrate_runtime::api::dispatch,
	adex_protocol_substrate_runtime::native_version,
	include_bytes!("../runtime/wasm/target/wasm32-unknown-unknown/release/adex_protocol_substrate_runtime.compact.wasm")
);
